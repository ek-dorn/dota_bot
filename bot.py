...
keywords2 = ["че по Диме", "че по диме", "что по Диме", "Дима сегодня"]
...
reply_dima1 = f"Дима сейчас на работе"
reply_dima2 = f"Дима сегодня чиллит, [чел](tg://user?id=469730736) го доту"
reply_dima3 = f"Диме завтра утром на работу, но мб скатает одну с нами"
reply_dima4 = f"Уже поздно, а Диме завтра на работу. Видимо без него сегодня"
...
async def keyword_response(update: Update, _: ContextTypes.DEFAULT_TYPE) -> None:
    ...
    replies_dima = [reply_dima1, reply_dima2, reply_dima3, reply_dima4]
    ...
    for keyword in keywords2:
        if keyword in message:
            await update.message.reply_text(random.choice(replies_dima), parse_mode=ParseMode.MARKDOWN)
            return
