...
reply6 = f"Собрал короче аналитику по вчерашним играм:\n\n__[Миша](tg://user?id=129026381) на первой позиции__ опять фармит как мудак. Без негатива, конечно, но если ты хочешь, чтобы тебя любила мама и не били в школе, иди в игру с ботами и фарми 13 часов, пока не научишься добивать крипов за Аппарата.\n\n__[Дима](tg://user?id=469730736) на миду__ как всегда прекрасен, хотя можно было не стилить у Миши фраг на 7 минуте. Ты видел, как он этого пуджа раздамажил? Не видел, потому что готовился стилить...\n\n__[Саша](tg://user?id=125631977) на тройке__ каждую игру фидит вражескому саппорту, превращая его в машину-убийцу с КДА 50. Не помогает и то, что он каждый раз стоит на линии с какими-то рандомами.\n\n__[Ваня](tg://user?id=274528988) на пятерке__ опять втягивает керри в файт, зная, что у него непереносимость спокойного фарма и зависимость от залета 1 в 3 под башню. В конечном итоге саппорт собирается в керри, керри собирается идти срать, а хардлайнер сам становится унитазом.\n\n__[Женя](tg://user?id=274528988)__ же в этот раз был на нулевой позиции пидораса, который не пришел на катку. Что поделать? Ничего не поделать... Через пару лет он женится и заведет детей, счастья ему!\n\n__Общие рекомендации:__\n   1.Ване стоит чередовать линии между Мишей и Сашей. Вы с Саньком неплохо стоите вместе, статистика это подтверждает. Однако не стоит забывать иногда приходить на изи лейн на ганги. \n   2. Мишу уже обоссали, его ничего не сделает нормальным керри. \n   3. А Саньку главная рекомендация - прежде всего смотреть на экран и реагировать на появление врагов. Не надо ходить по реке в самом начале игры - тебя видят все враги. Не надо стоять афк в метре от врагов на линии. Собираешься открыть лавку - затеряйся в лесах, чтобы спокойно стоять."
...
async def keyword_response(update: Update, _: ContextTypes.DEFAULT_TYPE) -> None:
    ...
    # String with date
    reply5 = f"Гороскоп на {format1}: \n \n__♑__ [Козерогов](tg://user?id=274528988) сегодня ждет удача на роли саппорта. Однако без вардов не обойтись даже в самой лоускилльной игре. \n \n__♊__ [Близнецам](tg://user?id=469730736) рекомендуется стоять на миду и раз в 5 минут приходить на ганг к своим товарищам, а то их к крипам не подпускает соперник. \n \n__♋__ [Раки](tg://user?id=129026381) и их [клешни](tg://user?id=125631977) сегодня узнают, почему баунти хантер не контрится на их рейтинге. Однако с хорошей поддержкой счет 1/7/20 им обеспечен. А что? Он же положительный, даже для керри. \n \n__♌__ [Львам](tg://user?id=89097615) сегодня предначертано вновь быть пидорасами с личной жизнью, которые никогда не залетают с пацанами на катку. Однако любой прогноз обратим при должной силе воли."
